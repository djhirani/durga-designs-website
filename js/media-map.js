...
const DD_ASSETS = {
  ...
  categories: [
    ...
    {
      id:          "cat-shoulder-bags",
      title:       "Embroidered Shoulder Bags",
      slug:        "shoulder-bags",
      cover:       "images/optimized/shoulder-bag-mirror-tote.jpg",
      coverAlt:    "Hand-embroidered Sindhi shoulder bags at Durga Designs Birmingham",
      description: "Handcrafted mirror-work and embroidered shoulder bags — one-of-a-kind pieces.",
      link:        "collections.html?cat=shoulder-bags",
      cta:         "View Collection",
      active:      true,
      order:       9
    },
    {
      ...
      slug:        "kurtas",
      cover:       "images/optimized/kurta-sindhi-full-embroidery.jpg",
      coverAlt:    "Sindhi hand-embroidered kurtas at Durga Designs Birmingham",
      description: "Traditional Sindhi kurtas with intricate hand embroidery and mirror work.",
      link:        "collections.html?cat=kurtas",
      cta:         "View Collection",
      active:      true,
      order:       10
    },
    {
      ...
      slug:        "wall-hangings",
      cover:       "images/optimized/wall-hanging-elephant.jpg",
      coverAlt:    "Handcrafted embroidered wall hangings at Durga Designs Birmingham",
      description: "Statement patchwork and embroidered wall art — bring heritage into your home.",
      link:        "collections.html?cat=wall-hangings",
      cta:         "View Collection",
      active:      true,
      order:       11
    }
  ...
  products: [
    ...
    /* ── EMBROIDERED SHOULDER BAGS ──────────────────────────── */
    {
      id:           "shoulder-bag-mirror-tote",
      title:        "Mirror-Work Embroidered Tote",
      category:     "shoulder-bags",
      categoryLabel:"Embroidered Shoulder Bags",
      src:          "images/optimized/shoulder-bag-mirror-tote.jpg",
      alt:          "Hand-embroidered mirror-work tote bag in red and green at Durga Designs Birmingham",
      description:  "Richly embroidered tote with traditional Sindhi mirror work in deep red and emerald.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Mirror-Work Embroidered Tote bag. Is it available?",
      active:       true,
      featured:     true,
      order:        1
    },
    {
      id:           "shoulder-bag-pink-tassel",
      title:        "Pink Tassel Boho Bag",
      category:     "shoulder-bags",
      categoryLabel:"Embroidered Shoulder Bags",
      src:          "images/optimized/shoulder-bag-pink-tassel.jpg",
      alt:          "Pink embroidered boho shoulder bag with tassels at Durga Designs Birmingham",
      description:  "Vibrant pink crossbody with colourful pom-pom tassels and floral embroidery.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Pink Tassel Boho Bag. Is it available?",
      active:       true,
      featured:     false,
      order:        2
    },
    {
      id:           "shoulder-bag-black-red",
      title:        "Black &amp; Red Geometric Tote",
      category:     "shoulder-bags",
      categoryLabel:"Embroidered Shoulder Bags",
      src:          "images/optimized/shoulder-bag-black-red.jpg",
      alt:          "Black and red geometric embroidered tote bag at Durga Designs Birmingham",
      description:  "Striking geometric embroidery on black — a bold everyday statement piece.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Black and Red Geometric Tote. Is it available?",
      active:       true,
      featured:     false,
      order:        3
    },
    {
      id:           "shoulder-bag-yellow-patchwork",
      title:        "Yellow Patchwork Shoulder Bag",
      category:     "shoulder-bags",
      categoryLabel:"Embroidered Shoulder Bags",
      src:          "images/optimized/shoulder-bag-yellow-patchwork.jpg",
      alt:          "Yellow patchwork embroidered shoulder bag at Durga Designs Birmingham",
      description:  "Sunny yellow patchwork with intricate borders — handcrafted and unique.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Yellow Patchwork Shoulder Bag. Is it available?",
      active:       true,
      featured:     true,
      order:        4
    },
    {
      id:           "shoulder-bag-round-pompom",
      title:        "Round Pom-Pom Sling Bag",
      category:     "shoulder-bags",
      categoryLabel:"Embroidered Shoulder Bags",
      src:          "images/optimized/shoulder-bag-round-pompom.jpg",
      alt:          "Round embroidered sling bag with pom-pom trim at Durga Designs Birmingham",
      description:  "Playful round sling bag edged with pom-poms and filled with colour.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Round Pom-Pom Sling Bag. Is it available?",
      active:       true,
      featured:     false,
      order:        5
    },

    /* ── SINDHI EMBROIDERED KURTAS ──────────────────────────── */
    {
      id:           "kurta-pink",
      title:        "Pink Ajrak Kurta",
      category:     "kurtas",
      categoryLabel:"Sindhi Embroidered Kurtas",
      src:          "images/optimized/kurta-pink.jpg",
      alt:          "Pink printed kurta with embroidered yoke at Durga Designs Birmingham",
      description:  "Soft pink printed kurta with a hand-embroidered blue yoke.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Pink Ajrak Kurta. Is it available?",
      active:       true,
      featured:     false,
      order:        1
    },
    {
      id:           "kurta-green",
      title:        "Green Printed Kurta",
      category:     "kurtas",
      categoryLabel:"Sindhi Embroidered Kurtas",
      src:          "images/optimized/kurta-green.jpg",
      alt:          "Green printed kurta with embroidered neckline at Durga Designs Birmingham",
      description:  "Fresh green kurta with delicate embroidery — light, elegant and comfortable.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Green Printed Kurta. Is it available?",
      active:       true,
      featured:     true,
      order:        2
    },
    {
      id:           "kurta-mustard",
      title:        "Mustard Embroidered Kurta",
      category:     "kurtas",
      categoryLabel:"Sindhi Embroidered Kurtas",
      src:          "images/optimized/kurta-mustard.jpg",
      alt:          "Mustard yellow kurta with embroidered yoke at Durga Designs Birmingham",
      description:  "Warm mustard kurta with a richly embroidered yoke and pom-pom trim.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Mustard Embroidered Kurta. Is it available?",
      active:       true,
      featured:     false,
      order:        3
    },
    {
      id:           "kurta-red-frock",
      title:        "Red Frock-Style Kurta",
      category:     "kurtas",
      categoryLabel:"Sindhi Embroidered Kurtas",
      src:          "images/optimized/kurta-red-frock.jpg",
      alt:          "Red frock-style kurta with embroidered front at Durga Designs Birmingham",
      description:  "Festive red frock-style kurta with an ornate embroidered front panel.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Red Frock-Style Kurta. Is it available?",
      active:       true,
      featured:     false,
      order:        4
    },
    {
      id:           "kurta-sindhi-full-embroidery",
      title:        "Fully Embroidered Sindhi Kurta",
      category:     "kurtas",
      categoryLabel:"Sindhi Embroidered Kurtas",
      src:          "images/optimized/kurta-sindhi-full-embroidery.jpg",
      alt:          "Fully hand-embroidered Sindhi kurta with mirror work at Durga Designs Birmingham",
      description:  "Show-stopping Sindhi kurta covered in hand embroidery and mirror detail — a true heirloom piece.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Fully Embroidered Sindhi Kurta. Is it available?",
      active:       true,
      featured:     true,
      order:        5
    },
    ...
    {
      id:           "wall-hanging-camel",
      title:        "Camel Embroidered Wall Hanging",
      category:     "wall-hangings",
      categoryLabel:"Handcrafted Wall Hangings",
      src:          "images/optimized/wall-hanging-camel.jpg",
      alt:          "Embroidered camel wall hanging with floral border at Durga Designs Birmingham",
      description:  "Hand-embroidered camel motif framed by vibrant floral medallions.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Camel Embroidered Wall Hanging. Is it available?",
      active:       true,
      featured:     false,
      order:        1
    },
    {
      id:           "wall-hanging-peacock",
      title:        "Peacock Embroidered Wall Hanging",
      category:     "wall-hangings",
      categoryLabel:"Handcrafted Wall Hangings",
      src:          "images/optimized/wall-hanging-peacock.jpg",
      alt:          "Embroidered peacock wall hanging at Durga Designs Birmingham",
      description:  "Graceful peacock scene stitched in rich traditional colours.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Peacock Embroidered Wall Hanging. Is it available?",
      active:       true,
      featured:     false,
      order:        2
    },
    {
      id:           "wall-hanging-elephant",
      title:        "Elephant Embroidered Wall Hanging",
      category:     "wall-hangings",
      categoryLabel:"Handcrafted Wall Hangings",
      src:          "images/optimized/wall-hanging-elephant.jpg",
      alt:          "Embroidered elephant wall hanging at Durga Designs Birmingham",
      description:  "Majestic decorated elephant, hand-stitched with ornate borders.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Elephant Embroidered Wall Hanging. Is it available?",
      active:       true,
      featured:     true,
      order:        3
    },
    {
      id:           "wall-hanging-tree-of-life",
      title:        "Tree of Life Wall Hanging",
      category:     "wall-hangings",
      categoryLabel:"Handcrafted Wall Hangings",
      src:          "images/optimized/wall-hanging-tree-of-life.jpg",
      alt:          "Tree of life embroidered wall hanging at Durga Designs Birmingham",
      description:  "Symbolic tree-of-life design surrounded by detailed patchwork borders.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Tree of Life Wall Hanging. Is it available?",
      active:       true,
      featured:     false,
      order:        4
    },
    {
      id:           "wall-hanging-floral",
      title:        "Floral Medallion Wall Hanging",
      category:     "wall-hangings",
      categoryLabel:"Handcrafted Wall Hangings",
      src:          "images/optimized/wall-hanging-floral.jpg",
      alt:          "Floral medallion embroidered wall hanging at Durga Designs Birmingham",
      description:  "All-over floral medallions in jewel tones — a vibrant heritage statement.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Floral Medallion Wall Hanging. Is it available?",
      active:       true,
      featured:     false,
      order:        5
    },
    {
      id:           "round-wall-hanging-1",
      title:        "Round Patchwork Wall Hanging — Pink",
      category:     "wall-hangings",
      categoryLabel:"Handcrafted Wall Hangings",
      src:          "images/optimized/round-wall-hanging-1.jpg",
      alt:          "Round patchwork wall hanging in pink tones at Durga Designs Birmingham",
      description:  "Circular patchwork of vintage embroidered textiles in pink and magenta tones.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Round Patchwork Wall Hanging (Pink). Is it available?",
      active:       true,
      featured:     false,
      order:        6
    },
    {
      id:           "round-wall-hanging-2",
      title:        "Round Patchwork Wall Hanging — Rose",
      category:     "wall-hangings",
      categoryLabel:"Handcrafted Wall Hangings",
      src:          "images/optimized/round-wall-hanging-2.jpg",
      alt:          "Round patchwork wall hanging in rose and blue tones at Durga Designs Birmingham",
      description:  "Hand-pieced circular wall art blending rose, blue and mirror-work fabrics.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Round Patchwork Wall Hanging (Rose). Is it available?",
      active:       true,
      featured:     false,
      order:        7
    },
    {
      id:           "round-wall-hanging-3",
      title:        "Round Patchwork Wall Hanging — Multicolour",
      category:     "wall-hangings",
      categoryLabel:"Handcrafted Wall Hangings",
      src:          "images/optimized/round-wall-hanging-3.jpg",
      alt:          "Round multicolour patchwork wall hanging at Durga Designs Birmingham",
      description:  "A kaleidoscope of embroidered patches stitched into a striking circle.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Round Patchwork Wall Hanging (Multicolour). Is it available?",
      active:       true,
      featured:     true,
      order:        8
    },
    {
      id:           "round-wall-hanging-4",
      title:        "Round Patchwork Wall Hanging — Jewel",
      category:     "wall-hangings",
      categoryLabel:"Handcrafted Wall Hangings",
      src:          "images/optimized/round-wall-hanging-4.jpg",
      alt:          "Round jewel-tone patchwork wall hanging at Durga Designs Birmingham",
      description:  "Jewel-toned patchwork circle with bold reds, purples and golds.",
      price:        "Ask for price",
      badge:        "New",
      whatsappMsg:  "Hi Durga Designs, I am interested in the Round Patchwork Wall Hanging (Jewel). Is it available?",
      active:       true,
      featured:     false,
      order:        9
    }
